...
export default function RefundPolicyPage() {
  ...
  const tdHead: React.CSSProperties = { padding: '12px 14px', borderBottom: `1px solid ${C.border}`, color: C.text, fontWeight: 600, verticalAlign: 'top' }
  const td: React.CSSProperties = { padding: '12px 14px', borderBottom: `1px solid ${C.border}`, color: C.muted, verticalAlign: 'top' }
    ...
    <LegalShell>
      ...
      <aside style={asideStyle}>
        <p style={{ ...body, fontSize: 13, margin: 0, lineHeight: 1.65 }}>
          This policy sets out the terms under which Zanovo issues refunds and processes cancellations. It applies to all
          clients and is intended to be fair to both parties.{' '}
      ...
      <p style={body}>
        <strong style={{ color: C.text }}>Zanovo</strong> (referred to as "we", "us", or "our") is a South Africa-based
        digital growth agency providing web design, AI lead generation systems, and automation services to small
        businesses. Contact us at <a href="mailto:thabiso@zanovo.co.za" style={{ color: C.accent }}>thabiso@zanovo.co.za</a>{' '}
        with any queries relating to this policy.
      </p>

      <h2 style={sectionTitle}>2. Scope</h2>
      <p style={body}>
        This policy applies to all payments made to Zanovo, including setup fees, monthly retainers, and project-based work.
        By making a payment, you acknowledge and agree to the terms described here.
      </p>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: 'system-ui, sans-serif', fontSize: 13 }}>
          ...
          <tbody>
            {[
              ...
              <tr key={i}>
                <td style={tdHead}>{service}</td>
                <td style={td}>{refund}</td>
      ...
      <p style={body}>
        For custom website builds, AI system builds, and other project-based work, the following refund schedule applies
        from the date the client pays the deposit and Zanovo begins work:
      </p>
      <ul style={list}>
      ...
      <p style={body}>
        "Work starting" means the moment Zanovo begins any substantive activity on your project — including the planning
        call, design, development, or configuration of your systems.
      </p>

      <h2 style={sectionTitle}>6. Monthly retainer</h2>
      <p style={body}>
        Monthly retainer fees are non-refundable. If you cancel your retainer, your services and access will remain active
        until the end of the calendar month for which payment was made. No partial refunds are issued for unused days within
        a paid month.
      </p>
      <p style={body}>
        Cancellations must be submitted in writing to{' '}
        <a href="mailto:thabiso@zanovo.co.za" style={{ color: C.accent }}>thabiso@zanovo.co.za</a>. The final month's fee is
        non-refundable under any circumstances. Cancellations take effect at the end of the month in which written notice is
        received.
      </p>

      <h2 style={sectionTitle}>7. Setup fee</h2>
      <p style={body}>
        The setup fee is non-refundable once Zanovo has delivered the agreed service or deliverable. The setup fee is only
        refundable if Zanovo fails to complete the agreed scope of work. In that event, a full refund of the setup fee will
        be issued within 10 business days of the failure being acknowledged.
      </p>
      <p style={body}>
        For clarity: making a payment and receiving a planning call constitutes the beginning of delivery. The setup fee is
        not refundable solely because you change your mind after the planning process has commenced.
      </p>

      <h2 style={sectionTitle}>8. Defective service</h2>
      <p style={body}>
        If a delivered service materially fails to meet the agreed specification — through no fault of the client — you are
        entitled to raise this in writing within <strong style={{ color: C.text }}>one month of delivery</strong>. Depending
        on the nature and severity of the defect, Zanovo will either:
      </p>
      <ul style={list}>
      ...
      <p style={body}>
        Defect claims raised after one month from delivery will not be eligible for a refund. This does not affect your
        rights under applicable South African consumer protection law.
      </p>

      <h2 style={sectionTitle}>9. How to request a refund or cancellation</h2>
      <p style={body}>All refund and cancellation requests must be made in writing. To initiate a request:</p>
      <ul style={list}>
      ...
      <p style={body}>
        Approved refunds will be issued via EFT to the South African bank account from which the original payment was made,
        or to an alternative account you specify. Zanovo does not issue refunds to third-party accounts unless explicitly
        agreed in writing. Processing times may vary depending on your bank (typically 1–3 business days after Zanovo
        initiates the payment).
      </p>

      <h2 style={sectionTitle}>11. Consumer Protection Act (South Africa)</h2>
      <p style={body}>
        Nothing in this policy is intended to limit or exclude rights you hold under the South African Consumer Protection
        Act, 2008 ("CPA"), where those rights apply. If there is any conflict between this policy and your rights under the
        CPA, your statutory rights take precedence.
      </p>

      <h2 style={sectionTitle}>12. Changes to this policy</h2>
      <p style={body}>
        Zanovo may update this policy from time to time. The effective date at the top of this page will reflect the most
        recent revision. Changes will not apply retroactively to payments already made under a prior version of this policy.
      </p>
